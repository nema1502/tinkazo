...
export const T: Record<Lang, Dict> = {
  es: {
    ...
    ctaHero: "Sortear ahora — es gratis",
    ...
    vSealsOnly: "Este organizador no selló ninguna otra lista en las últimas horas.",
    vSealsWindow: "últimas horas",
    vSealsMany: "últimas horas · hay más de los que entran acá",
  ...
  en: {
    ...
    ctaHero: "Run a raffle now — it's free",
    ...
    vSealsOnly: "This organizer sealed no other list in the last few hours.",
    vSealsWindow: "last few hours",
    vSealsMany: "last few hours · there are more than fit here",
