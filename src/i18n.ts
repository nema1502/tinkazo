...
export const T: Record<Lang, Dict> = {
  es: {
    ...
    masJuegosT: "Los seis juegos",
    masJuegosB: "Carrera de llamas, ruleta, pasanaku y tres más, con la captura de cada uno.",
    ...
    hiReglaB: "Si un elemento se puede sacar sin que nada deje de funcionar, es decoración y sobra. En el producto hay exactamente cuatro cosas bolivianas y las cuatro hacen algo: el nombre, la llama de la mascota, el perno tricolor de la ruleta que marca la vuelta, y el aguayo del Pasanaku que es el tablero. No hay wiphalas de fondo ni cholitas de stock.",
  ...
  en: {
    ...
    masJuegosT: "The six games",
    masJuegosB: "Llama race, wheel, pasanaku and three more, with a shot of each one.",
    ...
    hiReglaB: "If an element can be removed and nothing stops working, it is decoration and it goes. The product has exactly four Bolivian things and all four do something: the name, the llama mascot, the wheel's tricolor pin that marks the turn, and the Pasanaku's aguayo, which is the board. No wiphalas in the background, no stock photos.",
