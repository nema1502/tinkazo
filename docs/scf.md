...
Nada lo impide del todo, y es el borde real del diseño: está documentado en [amenazas.md](amenazas.md) desde antes de que nadie preguntara. Lo que sí hay: **la propia página de verificación trae y muestra todos los sellos de esa dirección**, leídos del estado del contrato, con cuánta gente tenía cada lista y contra qué ronda. Si selló cinco, se ven las cinco, y la página marca sola los que repiten la lista y los que tienen la misma cantidad de gente. El límite también se dice: un sello cuyo alquiler venció se archiva y deja de aparecer hasta que alguien lo restaure. **Decir esto sin que lo pregunten es lo que hace ver serio a un proyecto.**
